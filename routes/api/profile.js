...
// @des     Add experience to a Profile
// @access  Private
router.post(
  '/experience',
  passport.authenticate('jwt', { session: false }),
...
router.post(
  ...
  passport.authenticate('jwt', { session: false }),
  (req, res) => {
    const { errors, isValid } = validateEducationeInput(req.body);
...
// @des     Remove experience from the Profile
// @access  Private
router.delete(
  '/experience/:exp_id',
  passport.authenticate('jwt', { session: false }),
...
// @des     Remove education from the Profile
// @access  Private
router.delete(
  '/education/:edu_id',
  passport.authenticate('jwt', { session: false }),
...
// @des     Remove the user and profile
// @access  Private
router.delete(
  '/',
  passport.authenticate('jwt', { session: false }),
